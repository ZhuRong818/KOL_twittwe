...
TOP_N_OUTPUT = 300
OUT_RANKED_CSV = "tech_full.csv"
OUT_TOP_TXT = "tech_top300.txt"
...
# =========================
CORE_TECH = [
    "software engineering", "computer science", "systems engineering",
    "distributed systems", "system design", "scalable systems",
    "backend", "frontend", "full stack",
    "infrastructure", "platform engineering",
    "cloud computing", "edge computing",
    "devops", "sre", "observability",
    "database systems", "data infrastructure", "ai"
]
...
TECH_KEYPHRASES = (
    CORE_TECH + DEV_ECOSYSTEM + LANG_RUNTIME + AI_DATA
